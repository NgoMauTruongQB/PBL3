...
<link rel="stylesheet"
	href="./View/assets/fonts/fontawesome-free-6.3.0-web/css/all.min.css">
  ...
  if (SuccessDonation) {
	...
	<div id="main">
		...
		<form action="verifyDonation_controller" method="post">
			...
			<div id="wrapper">
				<div>
					<h2 id="donate">Ủng Hộ Nuôi Trẻ Tại Trung Tâm</h2>
				</div>
				<div id="line-up">
					<hr>
				</div>
				...
				<div class="content">
					...
					%>
					<div class="error">
						<span style="color: red; font-size: 14px"> <%=error%>
						</span>
					</div>
					...
					<div class="row">
						<div class="col col-full ">
							...
							<select name="charity_activities" class="control-form "
								placeholder="chọn hoạt động ủng hộ">
								<%
					...
					<div class="row">
						<div class="col col-full">
							...
							<input type="text" name="money" placeholder="Số tiền ủng hộ"
								class="control-form">
						</div>
					</div>
